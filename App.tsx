...
const AppContent: React.FC = () => {
    ...
    const navContent = (
      <>
        ...
        <div className="space-y-2">
            ...
            <NavItem icon={<AnalysisIcon className="w-6 h-6" />} label="History" isActive={activeView === 'history'} onClick={() => handleViewChange('history')} />
    ...
    return (
        <div className="md:flex h-screen bg-cosmic-bg text-cosmic-text-primary font-sans">
            ...
            <AddAccountModal isOpen={modalStates.isAddAccountModalOpen} onClose={() => actions.setModalOpen('isAddAccountModalOpen', false)} onAddAccount={actions.handleAddAccount} onSaveOverride={modalData.accountSaveOverride} accountToEdit={modalData.accountToEdit} teams={teams} defaultOwnerId={activeUser.id} contextTeamId={modalData.modalDefaultTeamId} onSuccess={modalData.addAccountSuccessCallback} />
            ...
            <CreateTeamModal isOpen={modalStates.isCreateTeamModalOpen} onClose={() => actions.setModalOpen('isCreateTeamModalOpen', false)} onCreateTeam={actions.handleCreateTeam} onSaveOverride={modalData.teamSaveOverride} currentUser={activeUser} teamToEdit={modalData.teamToEdit} />
